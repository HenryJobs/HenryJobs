...
const updatePost_routes_2 = __importDefault(require("./post/updatePost.routes"));
...
router.use("/post", updatePost_routes_2.default); // acordarse de agregar el tokenValidation
// follow
